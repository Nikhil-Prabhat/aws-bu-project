...
<body>
	...
	<div class="container">
		...
		<div style="position: relative; top: 40px">
			<h2 class="display-4 text-danger mt-5">Insurer Details</h2>
			<table class="table table-striped"
				style="position: relative; top: 40px">
				<thead>
					<tr>
						<th>Insurer Name</th>
						<th>Insurer Package Name</th>
						<th>Insurance Amount Limit ( &#8377;)</th>
						<th>Disbursement Duration(months)</th>

					</tr>
				</thead>

				<tbody>
					<c:forEach items="${allInsurer }" var="insurer">
						<tr>
							<td>${insurer.insurerName }</td>
							<td>${insurer.insurerPackageName }</td>
							<td>${insurer.insuranceAmountLimit }</td>
